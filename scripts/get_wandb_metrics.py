...
WANBD_PROJECT_NAME = "anonymous/tdqc"
...
WANDB_META_V2 = {
    ...
    "openvla_libero_v2": [
        # OpenVLA on the LIBERO benchmark
        {
            ...
            "exp_suffixes": ["lstm_clean", "mlp_clean", "lstm_TD0"], # "q_learning"
        ...
        },
        {
            "project_name": WANBD_PROJECT_NAME,
            "group_names": ["openvla_libero_v2"],
            "exp_suffixes": ["probs_only_TDLambda", "top_k_probs", "top_k_probs_lambda"],  # "q_learning"
            "ablated_configs": ["model.name", "dataset.token_idx_rel", "model.lr", "model.lambda_reg"],
            "group_configs": ["train.seed"],
            "extra_filters": {},
        },
...
if __name__ == "__main__":
    ...
    parser.add_argument("--benchmark", type=str, default="openvla_libero_v2", help="The benchmark to process")
